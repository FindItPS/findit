...
public class TechSearch extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void handleIntent(Intent intent) {
        ...
        if (Intent.ACTION_SEARCH.equals(intent.getAction())) {
            ...
            new SearchQuery(TechSearch.this, query, 4);
...
//        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_search) {
            startActivity(new Intent(TechSearch.this, HomeScreen.class));

        }  else if (id == R.id.nav_my_cart) {
            startActivity(new Intent(TechSearch.this, MyCart.class));
