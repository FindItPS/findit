...
public class SearchTemplate extends SearchQuery{
     ...
     */
    public SearchTemplate(Activity activity, Context context) {
        ...
        try {
            ...
            if(text.getText() != null){
                browser.loadUrl("https://api.bestbuy.com/v1/products((search=" + text.getText().toString() + "))?apiKey=qbBfecRN2JqSzbliyHCC0zMN&sort=name.asc&show=name,inStoreAvailability,regularPrice,salePrice&format=json");
