...
public class RCSuperstoreSearch extends SearchQuery{
    ...
    class fetcher extends AsyncTask<String, Void, Elements> {
        ...
        protected void onPostExecute(Elements result) {
            ...
            //For debug purposes, do NOt remove - **Important
            System.out.println("Adapter has been notified by Real Canadian Superstore.");
        ...
        try {
            ...
            for (int i = 0; i < e.size(); i++) {
                ...
                String store = "Real Canadian Superstore";
